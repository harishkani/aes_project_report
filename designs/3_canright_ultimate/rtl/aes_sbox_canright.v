...
////////////////////////////////////////////////////////////////////////////////
// AES S-box - Canright Algorithm (Complete Single-File Implementation)
// Reference: https://github.com/coruus/canright-aes-sboxes
// "A Very Compact S-Box for AES" - David Canright (2005)
//
// This file contains ALL Canright S-box modules in a single file for easy management.
// All 13 modules are defined here (no external dependencies).
//
// Module Hierarchy:
//   aes_sbox_canright (top-level wrapper)
//   └── bSbox (core S-box implementation)
//       ├── SELECT_NOT_8 (8-bit selector)
//       │   └── MUX21I (inverting mux) × 8
//       └── GF_INV_8 (GF(2^8) inverse)
//           ├── GF_MULS_4 (GF(2^4) multiply) × 2
//           │   ├── GF_MULS_2 (GF(2^2) multiply) × 2
//           │   └── GF_MULS_SCL_2 (GF(2^2) multiply & scale)
//           └── GF_INV_4 (GF(2^4) inverse)
//               ├── GF_SQ_2 (GF(2^2) square)
//               └── GF_MULS_2 (GF(2^2) multiply) × 2
//
// Usage: Simply include this one file in your project. No other Canright files needed.
////////////////////////////////////////////////////////////////////////////////

//==============================================================================
// GF(2^2) Primitive Operations
//==============================================================================
...
// Top-level wrapper with standard AES S-box interface
